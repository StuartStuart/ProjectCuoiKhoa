					...
					<div style="padding-left: 100px;">
						<table border="1" width="70%" class="tbl_input" cellpadding="4"
							...
							<tr>
								...
								<td align="left">
									${CommonUtil.showFormatDate(userinfor.birthDay) }</td>
							</tr>
							<tr>
							...
							<tbody
								...
								<tr>
									...
									<td align="left"><c:set
											value="${CommonUtil.showFormatDate(userinfor.startDate)}"
											var="startDate" /> ${(nameLevel == null)?'':startDate }</td>
								</tr>
								<tr>
									<td class="lbl_left">失効日:</td>
									<td align="left"><c:set
											value="${CommonUtil.showFormatDate(userinfor.endDate)}"
											var="endDate" /> ${(nameLevel == null)?'':endDate }</td>
								</tr>
								<tr>
